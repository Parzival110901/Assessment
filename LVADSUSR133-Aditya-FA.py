...
Original file is located at
    https://colab.research.google.com/drive/1td9HmUhu-CulK3rPyHYGdTQrUhPPMjVS
"""

#1 reading file using pandas
import pandas as pd

df=pd.read_excel('/content/Walmart_Dataset Python_Final_Assessment.xlsx')

#2 basic information on the file
df.info()

#3check and handle missing values drop /fill
import pandas as pd
...
#4identify and resolve duplicate enteries
...
duplicate_count_after_removal = df_unique.duplicated().sum()
print("Total duplicate entries after removal:", duplicate_count_after_removal)
...
#8Detecting and identifying Outliers based on box plot
import seaborn as sns
import matplotlib.pyplot as plt
...
#10 Product Category with highest growth
...
#10 product category with highest growth visualization
import seaborn as sns
import matplotlib.pyplot as plt
...
"""We can clearly see that supplies category jas the highest growth in terms of sales from a statistical view point as well as the visulization point of view"""
...
"""This shows us that by number of orders Arrian , Sanjith , Sally , bill with the highest number of orders  and Rick for lowest. For total sales its rickwilson who has the highest and bill who has the lowest"""

#12 Repeat Purchase Behaviour
import seaborn as sns
import matplotlib.pyplot as plt
import numpy as np
...
Certain demographic and psychographic characteristics may be associated with high-value customers, such as:
High income levels: Customers with higher disposable incomes are more likely to spend more on products or services.
Specific interests or preferences: Understanding customers' preferences and interests helps tailor marketing messages and product offerings.
Customer segmentation techniques can group customers based on these characteristics and target high-value segments with personalized marketing campaigns.
...
Personalized Marketing: Tailor marketing messages, promotions, and product recommendations to the preferences and behaviors of high-value customers.
Loyalty Programs: Offer exclusive rewards, discounts, and incentives to reward and retain high-value customers.
Customer Service Excellence: Provide exceptional customer service and support to enhance customer satisfaction and loyalty.
Cross-Selling and Upselling: Identify opportunities to cross-sell or upsell additional products or services to high-value customers based on their purchase history and preferences.
Retention Campaigns: Implement targeted retention campaigns to re-engage high-value customers who may be at risk of churn.
Data Analytics and Segmentation: Continuously analyze customer data and segment customers based on value and behavior to identify new high-value segments and refine targeting strategies.
"""